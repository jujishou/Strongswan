...
import org.strongswan.android.ui.fragment.VpnProfileListFragment.OnVpnProfileSelectedListener;

public class MainActivity extends AppCompatActivity implements OnVpnProfileSelectedListener {
    public static final String CONTACT_EMAIL = "android@strongswan.org";//联系邮箱，log页用
